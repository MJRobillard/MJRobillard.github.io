...
;(function($) {
	...
	ApFullscreenModal.prototype = {
		...
		_applyContent: function() {
			...
			this.$content.appendTo(this.$container.find('.' + cssPrefix + 'content'));
		...
		_updateHeadCss: function() {
			...
			css += "\tbottom: 0;\n";
			css += "}\n";
			css += "#" + containerId + " ." + cssPrefix + "wrapper {\n";
			css += "\twidth: 300px;\n"; // Adjust the width as per your requirement
			css += "\theight: 100%;\n";
			css += "}\n";
			css += "#" + containerId + " ." + cssPrefix + "content {\n";
			css += "\theight: 100%;\n";
			//css += "\tbackground-color: #fff;\n"; // Adjust the background color as per your requirement
			css += "}\n";
			css += "#" + containerId + " ." + cssPrefix + "close-button {\n";
			css += "\ttop: 10px;\n";
			css += "\tright: 10px;\n";
			css += "}\n";
	...
	'<div class="' + cssPrefix + 'container">' +
		'<div class="' + cssPrefix + 'wrapper ' + cssPrefix +'clearfix">' +
			'<div class="' + cssPrefix + 'content"></div>' +
